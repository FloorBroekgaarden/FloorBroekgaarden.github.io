...
<div class="event-card">
  ...
  <p>A caveat: hierarchical merger models typically produce more massive black holes at this stage (think 25+20 rather than 20+6), since a small black hole would tend to be ejected from its cluster before it could merge again. So the picture is intriguing but not clean. This is one where I would love to see what different formation models predict.</p>
</div>
